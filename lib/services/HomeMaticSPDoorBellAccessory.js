...
const { IMAGE_SETTINGS, imageSources } = require(path.join(__dirname, 'camera', 'doorbellSettings.js'))
...
class HomeMaticSPDoorBellAccessory extends HomeMaticAccessory {
  publishServices (Service, Characteristic) {
    ...
    this.stillImage = new StillImage(imageSources((key) => this.getDeviceSettings(key), this.deviceTypeOf(datapoint)), this.log, this._name)
