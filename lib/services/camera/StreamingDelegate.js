 ...
 *   watchdogInitialSeconds, bindUdpSocket, reserveUdpPortPair }
 */
class StreamingDelegate {
  ...
  prepareStream (request, callback) {
    Promise.allSettled([this.bindUdpSocket(request.addressVersion), this.reserveUdpPortPair(request.addressVersion)])
      .then(([bound, reserved]) => {
