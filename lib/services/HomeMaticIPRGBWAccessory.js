  ...
  publishServices (Service, Characteristic) {
    ...
    this.colorCharacteristic = this.service.getCharacteristic(Characteristic.Hue)
      .on('get', async (callback) => {
        const value = await self.getValueForDataPointNameWithSettingsKey('hue', null, false)
    ...
    this.saturationCharacteristic = this.service.getCharacteristic(Characteristic.Saturation)
      .on('get', async (callback) => {
        const value = await self.getValueForDataPointNameWithSettingsKey('saturation', null, false)
