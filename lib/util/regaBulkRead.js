...
/** true for a datapoint that reports an action (a key press), which has no value to read later */
function isActionDatapoint (address) {
  return ACTION.test(String(address))
}
...
module.exports = { isActionDatapoint, bulkReadScripts, parseBulkRead, FIELD_SEP, RECORD_SEP, CHUNK_SIZE }
