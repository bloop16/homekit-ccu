...
// the session check of the configuration service passes the id without its @
const BARE_SESSION = /(GetSessionVarStr\(\s*['"])[0-9a-zA-Z]{10}(['"])/g
// a session id in a query string, also URL encoded (%40...%40)
const SID_PARAM = /([?&]sid=)[^&#\s"']*/gi
